            ...
            <div className="w-full max-w-md p-8 space-y-3 rounded-xl bg-gray-50 border">
                ...
                <form noValidate="" action="" className="space-y-6">
                    <div className="space-y-1">
                        ...
                        <input type="text" name="name" id="name" placeholder="Name" className="w-full px-4 py-3 border rounded-md border-gray-400" />
                    </div>
                    <div className="space-y-1">
                        <label htmlFor="photoUrl" className="block dark:text-gray-600">Photo URL</label>
                        <input type="text" name="photoUrl" id="photoUrl" placeholder="Photo URL" className="w-full px-4 py-3 border rounded-md border-gray-400" />
                    </div>
                    <div className="space-y-1">
                    ...
                    <button className="block w-full p-3 text-center rounded-md dark:text-gray-50 dark:bg-violet-600">Register in</button>
                </form>
                <p className=" text-center sm:px-6 dark:text-gray-600">Already have an account?
                    <a rel="noopener noreferrer" href="#" className="underline text-blue-600"> Login</a>
                </p>
            </div>
        </section>
    );
